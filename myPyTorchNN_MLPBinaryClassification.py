...
Tutorial objective:
    ...
    How the five-step life-cycle of PyTorch models work
    How to define, fit, and evaluate models
...
Program objective:
    Develop an MLP (Multi Layer Perceptron) for Binary Classification
'''
