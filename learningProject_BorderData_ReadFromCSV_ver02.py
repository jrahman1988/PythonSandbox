...
stateList = ["AK", "ID", "ME", "MI", "MN", "MT", "ND", "NY", "VT", "WA"]
for i in stateList:
...
presidencyTermList = ["BC_Term2-(1996-00)", "GWB_Term1-(2001-04)", "GWB_Term2-(2005-08)", "BO_Term1-(2009-12)", "BO_Term2-(2013-16)", "DT_Term1-(2017-20)"]
presidencyStartYear = [1996, 2001, 2005, 2009, 2013, 2017]
presidencyEndYear = [2001, 2005, 2009, 2013, 2017, 2021]
for i in range(6):
