...
#URL of the web page from where the web scraping data will be captured
# urlAddress = 'https://www.trackcorona.live/'
...
#
# #Method to create data from web scraping and return the dataframe to caller
# def getDataFmWebScraping():
#     # Set the url to the website and access the site using requests library
#     urladdress = 'https://www.trackcorona.live/'
#     response = requests.get(urladdress)
#
#     # Parse the content of the .lxml document using BeautifulSoup library
#     soup = BeautifulSoup(response.content, 'lxml')
#
#     # Now find all 'table' from the .lxml document and put as a series named 'allTables' and tranform to a df
...
##--START: Read data thru web scraping and tranform into a DF ---------------------------##
# Set the url to the website and access the site using requests library
# url = "https://www.trackcorona.live/"
url = "https://worldpopulationreview.com/countries/saarc-countries/"
