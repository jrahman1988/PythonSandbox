...
#<--rename the column 'Country,Other' to 'Country'
vaccineDF = vaccineDF.rename(columns={'Location':'Country', 'Vaccinated[b]':'Vaccinated', '% of pop.[c]': '% of population'})
...
#<--replace all '--' values under '% of population' column with 0-->
vaccineDF['% of population'] = vaccineDF['% of population'].replace('--','0')
#<--remove all '%' at the end of values under '% of population' column-->
vaccineDF['% of population'] = (vaccineDF['% of population'].str.strip('%'))
#<--change the names of 'United States', 'United Arab Emirates' and 'United Kingdom' to 'USA', 'UAE' and 'UK' under Country column
